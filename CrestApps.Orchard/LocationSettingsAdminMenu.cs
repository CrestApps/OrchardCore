...
{
    public class LocationSettingsAdminMenu : INavigationProvider
    {
        private readonly IStringLocalizer T;


        public LocationSettingsAdminMenu(IStringLocalizer<LocationSettingsAdminMenu> stringLocalizer)
        {
            T = stringLocalizer;
        }
        ...
        public Task BuildNavigationAsync(string name, NavigationBuilder builder)
        {
            ...
            // in the admin menu.
            builder.Add(T["Locations"], "1", menu => menu
                ...
                // here!
                .AddClass("Locations").Id("Locations")
                ...
                // chained to this one.
                .Add(T["Create Location"], subitem => subitem
                    ...
                    .Action(nameof(LocationController.Create), typeof(LocationController).ControllerName(), new { area = PosConstants.Namespace })
                ...
                .Add(T["List Locations"], subitem => subitem
                    .LinkToFirstChild(true)
