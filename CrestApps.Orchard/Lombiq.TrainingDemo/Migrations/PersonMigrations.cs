...
namespace Lombiq.TrainingDemo.Migrations
{
    ...
    public class PersonMigrations : DataMigration
    {
        ...
        public int Create()
        {
            ...
            SchemaBuilder.CreateMapIndexTable(typeof(PersonPartIndex), table => table
            ...
            // but choose a meaningful one. Notice how we use a class with constants to store the type name so we
            // prevent risky copy-pasting.
